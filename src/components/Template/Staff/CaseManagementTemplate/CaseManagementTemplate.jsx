...
const CaseManagementTemplate = () => {
  ...
  return (
    <div className='p24'>
      <Wrapper   headerComponent={<TableHeader viewButtonText='Create new case' onClickViewAll={() => setShowCreateNewCaseModal(true)}  dropdownOptions={reactActivities}  selectedDropdownValue={selectedDropdownValue} setSelectedDropdownValue={setSelectedDropdownValue} title="Case Management" titleIcon={<FaRegFolderClosed color='#D9D9D9' size={20} />} />}>
